...
namespace Todo.Editor
{
    public class ToDoEditor : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            _watcher = new FileSystemWatcher(Application.dataPath + "/Scripts", "*.cs");
        ...
        {
            var assetsDir = new DirectoryInfo(Application.dataPath + "/Scripts");
            _files =
        ...
        {
            if (absolutePath.StartsWith(Application.dataPath + "/Scripts"))
                return "Assets" + absolutePath.Substring((Application.dataPath + "/Scripts").Length);
            else
